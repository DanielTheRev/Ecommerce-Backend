...
router.post('/banners', protect, adminOnly, validateSchema(CreateBannerSchema), BannerController.createBanner);
router.get('/banners/:id', protect, adminOnly, BannerController.getBannerById);
router.put('/banners/:id', protect, adminOnly, validateSchema(UpdateBannerSchema), BannerController.updateBanner);
